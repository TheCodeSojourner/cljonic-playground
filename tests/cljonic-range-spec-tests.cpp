...
TEST_CASE("Range supports the bounded integer producer subset", "[range]") {
  ...
  // Not exercised here: like
  // FloatingPointBoundsAndStepsAreRejectedAtCompileTime, this obligation is a
  // compile-time rejection and this project has no negative-compilation test
  // harness; verified by manual review instead.
  TRACE_ID("invariant.RangeSequence."
           "OversizedFiniteFormsAreCompileTimeErrorsWhenConstantEvaluated");
  TRACE_ID("invariant.RangeSequence."
