...
Each operation MUST define its callback, termination, equality, ordering, nested-result, producer, capacity, typed-absence, and bounded-result behavior as applicable:
