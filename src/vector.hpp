...
namespace cljonic
{
  ...
  public:
    ...
    static_assert(
        capacity_value <= CLJONIC_COLLECTION_MAXIMUM_ELEMENT_COUNT,
        "Vector capacity exceeds CLJONIC_COLLECTION_MAXIMUM_ELEMENT_COUNT=" CLJONIC_STRINGIFY(CLJONIC_COLLECTION_MAXIMUM_ELEMENT_COUNT));
